# # deploy level normal - this removes all debugging symobls
...
# deploy level development - with debuging symbols intact
...
# # deploy level extreme - this strips out all kind of information using the switch `-s` for gcc
